...
import RecordObjectsStatisticsTable from './RecordObjectsStatisticsTable'
import {ObjectsProps} from "../data/ObjectsProps";

const RecordObjectsTable = ({objectsData}) => {
    ...
    return <Box>
        ...
        <RecordObjectsStatisticsTable table={table}/>
    </Box>;
};

export default RecordObjectsTable